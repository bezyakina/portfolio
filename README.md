# Елизавета Безякина - QA Engineer
...
Работаю в сфере IT с 2016 года. В начале карьеры осуществляла контроль качества веб-приложений на базе Oracle CRM в консалтинговой компании [Siblion](https://siblion.ru). Получив свой первый опыт в качестве тестировщика, в 2018 году я решила попробовать себя в качестве QA Engineer и устроилась работать в крупнейшую технологическую компанию [Яндекс](https://yandex.ru/company/main) на проект [Едадил](https://edadeal.ru/) уже в качестве инженера по обеспечению качества, где и работаю на данный момент. В Едадиле я отвечаю за качество целого зоопарка back-end микросервисов и гибридных front-end web-app'ов (встраеваемых в нативные [ios](https://apps.apple.com/us/app/edadeal-скидки-и-магазины/id700569948) и [android](https://play.google.com/store/apps/details?id=com.edadeal.android&hl=ru&gl=US) приложения).
...
## Яндекс - Едадил, с февраля 2018
1. Участвую на всех этапах разработки фич - от идеи до сопровождения после релиза;
2. Занимаюсь контролем и обеспечением качества ключевых сервисов (back-end и front-end); 
3. Автоматизирую back-end регрессию (Python3+PyTest+Docker+TeamCity); 
4. Автоматизирую front-end регрессию верстки с помощью screenshot-тестов (JS+SeleniumGrid+Hermione);
5. Участвую в развитии системы тестирования регрессии с помощью асессоров (внешние тестировщики);
6. Провожу нагрузочное тестирование (Yandex.Tank);
7. Участвую в процессах найма новых сотрудников (собеседование и менторство).

**Технологии и инструменты**: Python3, PyTest, Requests, Docker, git, GitLab, TeamCity, Postman, JS, Selenium, Hermione, Yandex.Tank, PostgreSQL, cURL, Linux, Bash.

## Сиблион, с ноября 2016 по февраль 2018
1. Проводила ручное тестирование (функциональное, регресионное, интеграционное, системное, приемочное) для CRM-систем банков и телекома;
2. Разрабатывала тест-планы и тест-кейсы;
3. Проводила демонстрации и приемки новой функциональности для заказчиков;
4. Менторила стажеров-тестировщиков.
